...
func TestBoardsServiceListSprints(t *testing.T) {
	...
	mux.HandleFunc("/board/5259/sprint", func(w http.ResponseWriter, r *http.Request) {
		...
		"values": [{"id": 5259,"self": "https://jira.csc.com/rest/agile/1.0/sprint/5259","state": "closed","name": "CBD Tarefas Planning","startDate": "2018-09-18T17:30:00.000Z","endDate": "2018-09-19T01:30:00.000Z","completeDate": "2018-09-19T03:00:00.000Z","originBoardId": 2881,"goal": "Finalizar refinamento das estórias de agendamento, reserva de telefone e checagem de crédito."}]}`)
	})
	...
	want := []*Sprint{
		{
			...
			BoardID:  2881,
			Goal:     "Finalizar refinamento das estórias de agendamento, reserva de telefone e checagem de crédito.",
		},
	}
